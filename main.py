...
class View:                                                 #класс отрисовки
    def __init__(self):
        self.drawWindow()                                   #запускаем рисование

    def drawWindow(self):                                   #рисуем окно, и его элементы
        ...
        self.frame1 = tkinter.Frame(self.createdMainWindow)      #делим окно на две невидимые рамки
        self.frame2 = tkinter.Frame(self.createdMainWindow)
        ...
        self.label = tkinter.Label(self.frame2)         #метка для тестирования методов списка
